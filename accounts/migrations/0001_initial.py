    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrator'), ('LAW_ENFORCEMENT', 'Law Enforcement'), ('NGO', 'NGO Worker'), ('CITIZEN', 'Citizen')], default='CITIZEN', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iris_scan_hash', models.CharField(max_length=256)),
                ('facial_features', models.JSONField()),
                ('last_verified', models.DateTimeField(auto_now=True)),
                ('verification_count', models.IntegerField(default=0)),
                ('is_active', models.BooleanField(default=True)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='aadhaar_profile', to=settings.AUTH_USER_MODEL)),
            ],
            options={
